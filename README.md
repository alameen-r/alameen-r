...
**Tools & Platforms:** VS Code, Git, GitHub, Jupyter Notebook, Figma  
...
- Worked on **real-world projects** involving CRUD operations, REST APIs, and user authentication.  
- Learned front-end design with **HTML, CSS, and JavaScript**, focusing on clean UI/UX and maintainable code.  
- Gained a **foundational understanding of Machine Learning concepts** with exposure to libraries such as NumPy, Pandas, and Scikit-learn.  
